...
function mudaCorQuadrado(quadrado1, quadrado2, quadrado3){
    quadrado1.style.background = "#00af09"; 
    quadrado2.style.background = "#00af09"; 
    quadrado3.style.background = "#00af09"; 
}
...
function checaSequencia(quadrado1, quadrado2, quadrado3){
    let quadradosIguais = false;

    if(quadrado1.innerHTML !== "-" && quadrado1.innerHTML === quadrado2.innerHTML && quadrado2.innerHTML === quadrado3.innerHTML) {
        quadradosIguais = true
    }

    return quadradosIguais
}
...
function reiniciaJogo() {
    ...
    for (let i = 1; i < 10; i++) {
        ...
        quadrado.style.background = "#7eaffd";
        quadrado.style.color = "#7eaffd";
        quadrado.innerHTML = "-"
    }
